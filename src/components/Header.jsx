    ...
    <>
      <header style={{
        ...
        <button
          ...
          style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: "0.85rem", flexShrink: 0, transition: "transform 0.15s", background: "none", border: "none", padding: 0, marginLeft: isMobile ? "-0.35rem" : undefined }}
