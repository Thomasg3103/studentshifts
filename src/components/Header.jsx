    ...
    <>
      <header style={{
        ...
        <button
          ...
          style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: "0.85rem", flexShrink: 0, transition: "transform 0.15s", background: "none", border: "none", padding: 0, marginLeft: isMobile ? "-1.05rem" : undefined }}
...
function PersonIcon({ color = "white" }) {
  return (
    <svg aria-hidden="true" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
