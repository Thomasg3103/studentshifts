  ...
  return (
    <div style={{ marginTop: "0.5rem", marginBottom: "0.35rem" }}>
      ...
      {(isAccepted || isRejected || currentIdx > 0) && (
        <p style={{ margin: "0.2rem 0 0", fontSize: "0.7rem", fontWeight: "700", color: isAccepted ? "#16a34a" : isRejected ? "#dc2626" : "var(--color-brand)", textAlign: "center" }}>
  ...
  return (
    <div role="listitem" className="job-card" style={{ display: "flex", flexDirection: "column", padding: 0, overflow: "hidden", marginBottom: 0 }}>
      ...
      {(showMessage || showWithdraw || showRemove) && (
        <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", padding: "1.1rem 1rem 0.85rem", justifyContent: "center" }}>
          {showMessage && (
