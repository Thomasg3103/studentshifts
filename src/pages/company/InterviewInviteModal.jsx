        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          ...
          <div>
            ...
            <input
              ...
              style={{ width: "100%", padding: "0.5rem 0.7rem", borderRadius: "0.5rem", border: "1.5px solid #e2e8f0", fontSize: "1rem", fontFamily: "inherit", boxSizing: "border-box", color: "#374151" }}
            />
          </div>
        </div>
